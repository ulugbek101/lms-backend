...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    preferential_amount = models.DecimalField(
    ...
    def is_fully_paid(self) -> tuple[bool, Decimal]:
        ...
        group_price = (
            payment.student.preferential_amount
            if self.is_preferential
            else payment.group.price
        )
...
class Group(models.Model):
    ...
    price = models.DecimalField(
        max_digits=12, decimal_places=2, validators=[group_price_validator]
    )
    ...
    def save(self, *args, **kwargs):
        """Automatically update is_active based on start_date and end_date"""
